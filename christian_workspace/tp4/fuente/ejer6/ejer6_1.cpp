...
int main(int argc, char **argv) {
	...
	//el histograma se usa solamente cuando no uso una tolerancia dinamica como aca.... ves los picos del
	//color en el que te estas centrando y tomas desde es pico la campanita punto+tol, punto-tol y listo
