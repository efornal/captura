...
int main() {
	...
	CImgList<unsigned char> lista1(im1, im2, resta<CImg<unsigned char> > (im1,
	...
	CImgList<unsigned char> lista2(im1, im2, resta<CImg<unsigned char> > (im1,
			im2, false));
	...
	CImgList<unsigned char> lista3(im1, negativo(im1),
			resta<CImg<unsigned char> > (im1, negativo(im1), true));
	...
	CImgList<unsigned char> lista4(im1, negativo(im1),
			resta<CImg<unsigned char> > (im1, negativo(im1), false));
