 ...
 *
 *  2010 / 04 / 21
 *  Catedra 'Procesamiento Digital de Imagenes' - FICH, UNL
 *  http://pdi-fich.wikidot.com
 ****************************************************************************/
...
///****************************************
void magn_tdf(CImg<double> image,CImg<unsigned char> &magnitud_tdf,bool centrada=false){
...
if (cargar_paleta(paleta,"../../lib/paletas/gray.pal")!=0){
