...
// // // // // // // // // // // // // // // // // // // // // // // // // //
// // // // // // // // // // // // // // // // // // // // // // // // // //
void huffmanCodification(double data[], string HuffmanCodes[],
		double& Entropia, double& LongProm, double& Compresion, int dataSize) {
	...
	if (dataSize > 2) {
		...
		for (int n = 1; n < Simbolos.size(); n++) {
			if (arr[n] > 0) {
				...
				for (list<bool>::iterator it_b = Simbolos[n].begin(); it_b
						!= Simbolos[n].end(); it_b++) {
					if (*it_b == 1) {
						HuffmanCodes[n - 1] += "1";
					} else {
...
void huffmanCodification(double data[], string HuffmanCodes[],
		double& Compresion, int dataSize) {
	double E, L, C;
	huffmanCodification(data, HuffmanCodes, E, L, C, dataSize);
}
